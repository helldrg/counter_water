...
static const char font5x16[16][20] ={
		{ 0xFE, 0xFF, 0x03, 0x03, 0x03, 0xFF, 0xFE,
			  0x1F, 0x3F, 0x30, 0x30, 0x30, 0x3F, 0x1F,},  // 0
			{ 0x00, 0x00, 0x00, 0x0C, 0x0E, 0xFF, 0xFF,
			  0x00, 0x00, 0x00, 0x00, 0x00, 0x3F, 0x3F,},  // 1
			{ 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xFF, 0xFF,
			  0x3F, 0x3F, 0x30, 0x30, 0x30, 0x30, 0x30,},  // 2
			{ 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xFF, 0xFF,
			  0x30, 0x30, 0x30, 0x30, 0x30, 0x3F, 0x3F,},  // 3
			{ 0xFF, 0xFF, 0xC0, 0xC0, 0xC0, 0xFF, 0xFF,
			  0x00, 0x00, 0x00, 0x00, 0x00, 0x3F, 0x3F,},  // 4
			{ 0xFF, 0xFF, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3,
			  0x30, 0x30, 0x30, 0x30, 0x30, 0x3F, 0x3F,},  // 5
			{ 0xFF, 0xFF, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3,
			  0x3F, 0x3F, 0x30, 0x30, 0x30, 0x3F, 0x3F,},  // 6
			{ 0x03, 0x03, 0x03, 0x03, 0x03, 0xFF, 0xFF,
			  0x00, 0x00, 0x00, 0x00, 0x00, 0x3F, 0x3F,},  // 7
			{ 0xFF, 0xFF, 0xC3, 0xC3, 0xC3, 0xFF, 0xFF,
			  0x3F, 0x3F, 0x30, 0x30, 0x30, 0x3F, 0x3F,},  // 8
			{ 0xFF, 0xFF, 0xC3, 0xC3, 0xC3, 0xFF, 0xFF,
			  0x30, 0x30, 0x30, 0x30, 0x30, 0x3F, 0x3F,},  // 9
			{ 0x80, 0xC0, 0xC0, 0xC0, 0xC0, 0xC0, 0x80,
			  0x3F, 0x3F, 0x00, 0x3F, 0x00, 0x3F, 0x3F,},  // m
		    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			  0x00, 0x00, 0x38, 0x38, 0x38, 0x00, 0x00,},  // .
			{ 0xC3, 0xDB, 0xDB, 0xFF, 0x7E, 0x00, 0x00,
			  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,},  // ^
			{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,},  // space
			{ 0xFC, 0xFC, 0x00, 0x00, 0x00, 0xFC, 0xFC,
			  0x07, 0x0F, 0x1C, 0x3C, 0x1C, 0x0F, 0x07,},  // v
			{ 0xFC, 0xFC, 0x80, 0x80, 0x80, 0x80, 0x80,
			  0x3F, 0x3F, 0x31, 0x31, 0x31, 0x3F, 0x3F,},  // b
};
...
static const char font7x14[16][14] = {
		{ 0xFE, 0xFF, 0x03, 0x03, 0x03, 0xFF, 0xFE,
		  0x1F, 0x3F, 0x30, 0x30, 0x30, 0x3F, 0x1F,},  // 0
		{ 0x00, 0x00, 0x03, 0xFF, 0xFF, 0x00, 0x00,
		  0x00, 0x00, 0x00, 0x3F, 0x3F, 0x00, 0x00,},  // 1
		{ 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xFF, 0xFF,
		  0x3F, 0x3F, 0x30, 0x30, 0x30, 0x30, 0x30,},  // 2
		{ 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xFF, 0xFF,
		  0x30, 0x30, 0x30, 0x30, 0x30, 0x3F, 0x3F,},  // 3
		...
		{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,},  // space
		{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		  0x00, 0x00, 0x38, 0x38, 0x38, 0x00, 0x00,},  // dot
		{ 0xDB, 0xDB, 0xDB, 0xFF, 0xFF, 0x00, 0x00,
		  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,},  // ^
		{ 0xE0, 0xF0, 0x30, 0xF0, 0x30, 0xF0, 0xE0,
		  0x3F, 0x3F, 0x00, 0x3F, 0x00, 0x3F, 0x3F,},  // m
		{ 0xFC, 0xFC, 0x80, 0x80, 0x80, 0x80, 0x80,
		  0x3F, 0x3F, 0x31, 0x31, 0x31, 0x3F, 0x3F,},  // b
		{ 0xFC, 0xFC, 0x00, 0x00, 0x00, 0xFC, 0xFC,
		  0x0F, 0x1F, 0x38, 0x30, 0x38, 0x1F, 0x0F,},  // v
};
